...
<meta http-equiv="Cache-Control" content="no-siteapp" />
        <link href="{{asset('conadmin/assets/css/bootstrap.min.css')}}" rel="stylesheet" />
        <link rel="stylesheet" href="{{asset('conadmin/css/style.css')}}"/>       
        <link href="{{asset('conadmin/assets/css/codemirror.css')}}" rel="stylesheet">
        <link rel="stylesheet" href="{{asset('conadmin/assets/css/ace.min.css')}}" />
        <style>
			@font-face{
				　	font-family: "FontAwesome";
　　				src: url('{{asset('conadmin/font/fonts/fontawesome-webfont.eot')}}');
			}
        </style>
        <link rel="stylesheet" href="{{asset('conadmin/font/css/font-awesome.min.css')}}" />

        
        <!--[if lte IE 8]>
		  <link rel="stylesheet" href="assets/css/ace-ie.min.css" />
		<![endif]-->
		<script src="{{asset('conadmin/js/jquery-1.9.1.min.js')}}"></script>
        <script src="{{asset('conadmin/assets/js/bootstrap.min.js')}}"></script>
		<script src="{{asset('conadmin/assets/js/typeahead-bs2.min.js')}}"></script>           	
		<script src="{{asset('conadmin/assets/js/jquery.dataTables.min.js')}}"></script>
		<script src="{{asset('conadmin/assets/js/jquery.dataTables.bootstrap.js')}}"></script>
        <script src="{{asset('conadmin/assets/layer/layer.js')}}" type="text/javascript" ></script>          
        <script src="{{asset('conadmin/assets/laydate/laydate.js')}}" type="text/javascript"></script>
<title>管理权限</title>
</head>
...
function Competence_modify(id){
		window.location.href ="{{url('admin/competence_add')}}";//+id;
};	
/*字数限制*/
